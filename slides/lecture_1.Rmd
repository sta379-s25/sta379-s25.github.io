...
* **Computational statistics**: the use of computational algorithms algorithms to implement statistical methods (think: simulating data from a distribution, fitting a regression model, performing hypothesis testing)
...
**Usual goal:** Minimize type II error, subject to control of type I error (i.e. want $P(\text{reject } H_0 | H_0 \text{ true}) <= \alpha$)
...
Here we fail to reject $H_0$. Does this give us our type I error?
