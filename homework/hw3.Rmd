...
* In this problem, $g$ should *not* be a uniform density
* The Rayleigh distribution is supported on $[0, \infty)$. Think about other continuous distributions supported on $[0, \infty)$ which have a pdf which looks kind of similar to the Rayleigh pdf
:::
