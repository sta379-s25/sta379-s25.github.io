...
To approximate $\int \limits_a^b f(x) dx$, the (composite) trapezoid rule divides the interval $[a, b]$ into $n$ subintervals of equal length $h = n/(b - a)$. The approximation is
